...
-(MPDownloadState)addTaskWithDownLoadMusic:(MusicPartnerDownloadEntity *)mPDownloadEntity{
    ...
    if ([self continueDownLoad:mPDownloadEntity.downLoadUrlString]) {
        [self downLoad:mPDownloadEntity.downLoadUrlString progressBlock:nil completeBlock:nil mpDownloadState:MPDownloadStateSuspended];
    }
...
- (void)URLSession:(NSURLSession *)session dataTask:(NSURLSessionDataTask *)dataTask didReceiveData:(NSData *)data
{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:MpDownLoadProgressChange object:@{@"progress":@(progress),@"url":self.mpSessionModel.urlString}];
}
