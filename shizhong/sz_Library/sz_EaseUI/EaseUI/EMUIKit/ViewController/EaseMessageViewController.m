...
{
    NSDictionary *extDict=@{@"nickName":[sz_loginAccount currentAccount].login_nick,@"headerUrl":[sz_loginAccount currentAccount].login_head};
    [self sendTextMessage:text withExt:extDict];
}
