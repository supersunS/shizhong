...
@interface sz_likeViewController ()<UITableViewDataSource,UITableViewDelegate>

@end

@implementation sz_likeViewController
{
...
- (void)viewDidLoad {
    ...
    _sz_nav=[[likes_NavigationView alloc]initWithTitle:@"点赞" andLeftImage:[UIImage imageNamed:@"return"] andRightImage:nil andLeftAction:^{
    ...
    _dataArray=[[NSMutableArray alloc]initWithArray:[sz_sqliteManager checkAllMessageBySysType:sz_allPushMessage_like]];
    if([_dataArray count])
    {
        [_tableView reloadData];
    }
    [sz_sqliteManager updateLikesAllMessageBySysType:sz_allPushMessage_like andIsRead:YES];
}
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [cell setMesInfoObject:[_dataArray objectAtIndex:indexPath.row] isLike:YES];
    return cell;
}
